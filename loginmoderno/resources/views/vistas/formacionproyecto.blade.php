...
<html lang="en">
    ...
    <body>
        <h1 class="cabecera">Formulación del proyecto</h1>
        ...
        <div class="texto-centro">
            ...
            <blockquote>“aquello que acontece de manera verdadera o cierta, en oposición a lo que pertenece al terreno de la fantasía, la imaginación o la ilusión. Lo real, por lo tanto, es lo que existe efectivamente.”</blockquote>
                ...
                <div class="botones">
                    <button onclick="window.location.href='{{ url('/home') }}'" class="boton">Atrás</button>
                    <button onclick="window.location.href='{{ url('/Realidad') }}'" class="boton">Siguiente</button>
                </div>
    </body>
