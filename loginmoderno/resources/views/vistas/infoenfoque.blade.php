...
<body>
    ...
    <form class="texto-just" action="/workEnfoque/1" method='get'>
        ...
        <br />
        <br />
        <p> Teniendo en cuenta la formulación de su realidad a investigar, es importante identificar el enfoque y tipo
            de investigación en el cual se enmarcará el proyecto de investigación.
            Inicialmente partimos reconocer el concepto de  los diferentes enfoques de investigación aplicados en educación
        </p>
        <br />
