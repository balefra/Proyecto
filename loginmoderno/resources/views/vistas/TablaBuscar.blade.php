        ...
        <table class="table table-striped">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="50">Editar  -  PDF</th>
                </tr>
                <thead>
                ...
                <tbody>
                    <tr>
                        ...
                        <td><a href="{{ url("/formacionproyecto/{$reg->id}") }}"><img
                                    src="{{ asset('assets/images/editar.png') }}" class="imagenE"></a><a
                                href="{{ url("/infopdf/{$reg->id}") }}" target="_blank"><img
