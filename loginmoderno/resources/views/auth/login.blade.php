                        ...
                        <div class="row g-0">
                                    ...
                                    <form action="{{ route('login') }}" method="post">
                                        ...
                                        <div data-mdb-input-init class="form-outline mb-4">
                                            <input type="password" name="password" id="form2Example22"
                                                class="form-control" />
                                            <label class="form-label" for="form2Example22">Ingresar la
                                                contraseña</label>
                                        </div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-center pb-4">
                                            ...
                                            <a href="{{ route('register') }}" class="btn btn-outline-danger">Crear una
                                                nueva cuenta</a>
                                        </div>
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="justificado">Bienvenidos al asistente virtual de investigación en
                                        educación, esta aplicación virtual es una herramienta innovadora, diseñada por
                                        las Universidades Iberoamericana de Colombia y Tres culturas de México, para
                                        orientar paso a paso en el proceso investigativo.
                                    </p>
                                </div>
                            </div>
                        </div>
